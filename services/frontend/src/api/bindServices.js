 ...
 *
 *      Therefore, the fix is just to rebind `create` (and all the other service methods) back to the service.
 *
 *  Implementation Note:
 *
 ...
 *          2. Not use feathers and just write a whack ton of direct API call methods using Axios.
 */

const services = [
    "profiles", "profileSkills", "projectChangeRecords", "projectProfiles",
    "projects", "projectSkills", "skills", "users"
];

const serviceMethods = ["find", "get", "create", "update", "patch", "remove"];

const bindServices = (api) => (
